...
# Use seq2seq + Luong attention + copy mechanism + attributes + rating to generate
...
parser = argparse.ArgumentParser(description='seq2seqAttrRate2')
# path info
...
def evaluate(net, criterion, vocab, data_iter, train_next=True):
    ...
    for batch in tqdm(data_iter):
        ...
        sum_out = net(src, trg, src_, trg_, src_user, src_product, src_rating, vocab.word_num, test=True)
        sum_out_1 = net(src, trg, src_, trg_, src_user, src_product, src_rating, vocab.word_num, test=False)
